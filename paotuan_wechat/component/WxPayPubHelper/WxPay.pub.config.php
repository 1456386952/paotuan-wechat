...
class WxPayConf_pub
{
	...
	const APPID = 'wxe380ca3504f26643';
	//受理商ID，身份标识
	const MCHID = '1220390101';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = 'd19a4f7fc95036d7f5855e2c9d998e49';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = '7916f82922f82693c88a9dbe50d78ba7';
	
	//=======【JSAPI路径设置】===================================
	//获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
	const JS_API_CALL_URL = 'http://www.irunner.mobi/getCode.php';
	...
	const NOTIFY_URL = 'http://wechat.runningtogether.net/wxpay/notify';
