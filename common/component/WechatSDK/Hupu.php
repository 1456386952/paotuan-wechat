...
class Hupu
{
	...
	const OAUTH_PREFIX = ' https://irun.hupu.com';
	const OAUTH_AUTHORIZE_URL = '/oauth2/qrconnect?';
	const OAUTH_TOKEN_PREFIX = 'https://irun.hupu.com';
	const OAUTH_TOKEN_URL = '/oauth2/access_token?';
	const OAUTH_REFRESH_URL = '/oauth2/refresh_token?';
	const OAUTH_USERINFO_URL = 'https://irun.hupu.om/oauth2/userinfo?';
	...
	{
		$options = \Yii::$app->params['hupu_config'];
        return new Hupu($options);
	}
	/**
	...
	*/
	...
	public function getOauthRedirect($callback,$scope='user,sports'){
		return self::OAUTH_PREFIX.self::OAUTH_AUTHORIZE_URL.'appid='.$this->appid.'&redirect_uri='.rawurlencode($callback).'&response_type=code&SCOPE='.$scope.'&state=STATE';
	}
